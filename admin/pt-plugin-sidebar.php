...
<!-- side bar -->
		...
		<div class="sidebar alignright">
			<h1><b>Go Premium</b></h1>
			<h2> Why upgrade to Premium Version?</h2>
			<div class="border-bottom1"></div>
			<div>
				...
				<a href="http://edddemo.ourtempurl.com/index.php/sample-page/" target="_blank" class="button eael-btn eael-license-btn">Get Premium Version</a>
			</div>
		</div>
