...
class Group_Control_PT_Posts extends Group_Control_Base {
	...
	/**
	 * on_export_remove_setting_from_element
	 *
	 * @param  mixed $element
	 * @param  mixed $control_id
	 *
	 * @return $elements
	 */
	...
	protected function init_fields() {
		$fields              = [];
		$fields['post_type'] = [
			'label' => __( 'Source', 'pt-addons-elementor' ),
			'type'  => Controls_Manager::SELECT,
		];
		$fields['posts_ids'] = [
			'label'       => __( 'Search & Select', 'pt-addons-elementor' ),
		...
		$fields['authors']   = [
			'label'       => __( 'Author', 'pt-addons-elementor' ),
			'label_block' => true,
			'type'        => Controls_Manager::SELECT2,
			'multiple'    => true,
			'default'     => [],
	...
	protected function prepare_fields( $fields ) {
		$post_types                         = $this->pt_get_post_types();
		$post_types_options                 = $post_types;
		$post_types_options['by_id']        = __( 'Manual Selection', 'pt-addons-elementor' );
