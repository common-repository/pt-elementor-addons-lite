...
class PT_Installer {
	...
	public function init_hooks() {
		...
		add_action( 'wp_ajax_pt_upsale_core_install_' . $this->plugin_basename, array( $this, 'core_install' ) );
	}
	/**
	...
	public function core_install() {
		check_ajax_referer( 'pt_upsale_core_install_' . $this->plugin_basename );
		if ( ! current_user_can( 'manage_options' ) ) {
