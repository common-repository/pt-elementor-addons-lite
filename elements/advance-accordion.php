...
namespace Pt_Addons_Elementor\Elements\AdvanceAccordion;
...
class Advance_Accordion extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Advanced Accordion', 'pt-addons-elementor' );
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			'pt_adv_accordion_tab_icon_show',
		...
		$repeater->add_control(
			...
			'pt_adv_accordion_tab_default_active',
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, neque qui velit. Magni dolorum quidem ipsam eligendi, ', 'elementor' ),
	...
	[
		...
		'default' => [
			...
			[
				...
				'pt_adv_accordion_tab_title' => esc_html__( 'Tab Title #1', 'plugin-name' ),

				'pt_adv_accordion_tab_content' => esc_html__( 'Item content. Click the edit button to change this text.', 'plugin-name' ),

			],

			[

				'pt_adv_accordion_tab_title' => esc_html__( 'Tab Title #2', 'plugin-name' ),
			...
			[
				...
				'pt_adv_accordion_tab_title' => esc_html__( 'Tab Title #3', 'plugin-name' ),
...
/* text alignment function end here*/
		...
		$this->start_controls_tabs( 'pt_adv_accordion_header_tabs' );
			...
			$this->start_controls_tab( 'pt_adv_accordion_header_hover', [ 'label' => esc_html__( 'Hover', 'pt-addons-elementor' ) ] );
			...
			$this->start_controls_tab( 'pt_adv_accordion_header_active', [ 'label' => esc_html__( 'Active', 'pt-addons-elementor' ) ] );
	...
	<div class="pt-adv-accordion" id="pt-adv-accordion-<?php echo esc_attr( $this->get_id() ); ?>">
		...
		<div class="pt-accordion-list">
			...
			if ( $tab['pt_adv_accordion_tab_default_active'] == 'yes' ) :
			...
			"  >
				...
				if ( $tab['pt_adv_accordion_tab_icon_show'] === 'yes' ) :
					...
					<i class="<?php echo esc_attr( $settings['pt_adv_accordion_tab_title_icon'] ); ?> fa"></i><?php endif; ?>  <?php echo $tab['pt_adv_accordion_tab_title']; ?></span>

					<?php

					if ( $settings['pt_adv_accordion_icon_show'] === 'yes' ) :

						?>

					<i class="<?php echo esc_attr( $settings['pt_adv_accordion_icon'] ); ?> fa-toggle"></i> <?php endif; ?>
