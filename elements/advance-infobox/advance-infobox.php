<?php
namespace Elementor;
namespace Pt_Addons_Elementor\Elements\AdvanceInfobox;
...
class Advance_Infobox extends Widget_Base {

	public function get_name() {
		return 'pt-advance-infobox';
	}

	public function get_title() {
		return esc_html__( 'Advance Infobox', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .service-one__single' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .service-one__single' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
				'default' => [
	 					'{{WRAPPER}} service-one__single' => 'padding: {{TOP}}{{20}} {{RIGHT}}{{20}} {{BOTTOM}}{{20}} {{LEFT}}{{20}};',
	 			],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
	 					'{{WRAPPER}} .service-one__single' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	 			],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
				[
					...
					'selector' => '{{WRAPPER}} .service-one__single',
				]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .service-one__single' => 'border-radius: {{SIZE}}px;',
				],
			]
		);
		...
		/**
		 * -------------------------------------------
		 * Tab Style (Info Box Hover Style)
		 * -------------------------------------------
		 */
		$this->start_controls_section(
			'pt_section_hover_infobox_style_settings',
			[
				'label' => esc_html__( 'Info Box Hover Style', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE
			]
		);

		$this->add_control(
			'pt_infobox_bg_hover_color',
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .service-one__single:hover' => 'background-color: {{VALUE}};',
				],
			]
		);

		$this->add_control(
			'pt_infobox_hover_title_heading',
			[
				'label' => esc_html__( 'Title  Hover Style', 'elementor' ),
				'type' => Controls_Manager::HEADING,
			]
		);

		$this->add_control(
			'pt_infobox_hover _title_color',
			[
				'label' => esc_html__( 'Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#fff',
				'selectors' => [
					'{{WRAPPER}} .service-one__single:hover .pt-infobox2 .infobox-content .title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
             'name' => 'pt_infobox_hover_title_typography',
				'selector' => '{{WRAPPER}} .service-one__single:hover .pt-infobox2 .infobox-content .title',
			]
		);

	
		$this->add_control(
			'pt_infobox_hover_content_heading',
			[
		...
		$this->add_control(
			'pt_infobox-hover_content_color',
			[
				'label' => esc_html__( 'Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#4d4d4d',
				'selectors' => [
					'{{WRAPPER}} .service-one__single:hover .pt-infobox2 .infobox-content p' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
             'name' => 'pt_infobox_content_typography',
				'selector' => '{{WRAPPER}} .service-one__single:hover .pt-infobox2 .infobox-content p',
			]
		);
		...
		/**
		 * -------------------------------------------
		 * Tab Style (Info Box Icon Hover Style)
		 * -------------------------------------------
		 */
		$this->start_controls_section(
			'pt_section_infobox_hover _icon_style_settings',
			[
				'label' => esc_html__( 'Icon Hover  Style', 'elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
		     		'pt_infobox_img_or_icon' => 'icon'
		     	]
		...
		$this->add_control(
    		...
    		[
       		...
       		'type' => Controls_Manager::SLIDER,
        		...
        		'selectors' => [
            	'{{WRAPPER}} .service-one__single:hover .pt-infobox2 .infobox-icon i' => 'font-size: {{SIZE}}px;',
        		],
    		]
		);
		...
		$this->add_control(
    		...
    		[
        		...
        		'selectors' => [
            		'{{WRAPPER}} .service-one__single:hover .pt-infobox2 .infobox-icon .infobox-icon-wrap' => 'width: {{SIZE}}px; height: {{SIZE}}px;',
        		],
        		'condition' => [
					'pt_infobox_icon_bg_shape!' => 'none',
					'pt_infobox_img_type!' => ['img-on-left', 'img-on-right'],
		...
		$this->add_control(
			'pt_infobox_hover_icon_color',
			[
				'label' => esc_html__( 'Icon Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#4d4d4d',
				'selectors' => [
					'{{WRAPPER}} .service-one__single:hover .pt-infobox2 .infobox-icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .service-one__single:hover .pt-infobox2.icon-beside-title .infobox-content .title figure i' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'pt_infobox_hover_icon_bg_color',
			[
				'label' => esc_html__( 'Background Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#f4f4f4',
				'selectors' => [
					'{{WRAPPER}} .service-one__single:hover .pt-infobox2 .infobox-icon .infobox-icon-wrap' => 'background: {{VALUE}};',
				],
				'condition' => [
					'pt_infobox_img_type!' => ['img-on-left', 'img-on-right'],
					'pt_infobox_icon_bg_shape!' => 'none',
