<?php
namespace Elementor;
namespace Pt_Addons_Elementor\Elements\AdvanceTab;
...
class Advance_Tab extends Widget_Base
{
    ...
    {
        return esc_html__('Advance Tab', 'pt-addons-elementor');
    }
...
$repeater = new \Elementor\Repeater();
		...
		$repeater->add_control(
			'pt_adv_tabs_tab_show_as_default',
			[
...
/* end new controle*/
  		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'title_field' => esc_html__( 'Title #1', 'plugin-name' ),
						'pt_adv_tabs_tab_content' => esc_html__( 'Item content. Click the edit button to change this text.', 'plugin-name' ),
					],
					[
						'title_field' => esc_html__( 'Title #2', 'plugin-name' ),
						'pt_adv_tabs_tab_content' => esc_html__( 'Item content. Click the edit button to change this text.', 'plugin-name' ),
					],
					[
						'title_field' => esc_html__( 'Title #2', 'plugin-name' ),
 ...
 <div class="pt-advance-tabs" id="pt-advance-tabs-<?php echo esc_attr( $this->get_id() ); ?>">
	 ...
	 <div class="pt-tab-contents">
		 ...
		 <div class="pt-tab-content clearfix <?php echo esc_attr( $tab['pt_adv_tabs_tab_show_as_default'] ); ?>" id="pt-adv-tab-<?php echo esc_attr($pt_adv_tab_content_id); ?>">
			 ...
			 <?php echo $tab['pt_adv_tabs_tab_content']; ?>
		 </div>
 ...
 <style>
	 <?php echo "#pt-advance-tabs-".esc_attr( $this->get_id() ); ?> .pt-tab-navs li a.active:after {
		 display: none;
	 }
 </style>
 <?php endif; ?>
