...
class PT_Advance_Button_Widget extends Widget_Base
{ 
...
Plugin::instance()->widgets_manager->register_widget_type(new PT_Advance_Button_Widget());
