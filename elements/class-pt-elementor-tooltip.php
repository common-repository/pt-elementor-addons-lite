<?php
/**
 * Class Pt-elementor-tooltip.php
 *
...
class Widget_pt_Tooltip extends Widget_Base {
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_pt_Tooltip() );