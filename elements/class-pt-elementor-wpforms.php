<?php
/**
 * class-pt-elementor-wpforms.php
 *
...
if ( ! defined( 'ABSPATH' ) ) {
	 ...
	 */
class Pt_Elementor_Wpforms extends Widget_Base {
...
Plugin::instance()->widgets_manager->register_widget_type( new Pt_Elementor_Wpforms() );
