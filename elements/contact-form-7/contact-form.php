...
namespace Pt_Addons_Elementor\Elements\ContactForm7;
...
use \Elementor\Group_Control_Incound;
...

{
...

    {
        ...
        return esc_html__('Contact Form 7', 'pt-addons-elementor');
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => $this->pt_select_contact_form(),
