<?php
namespace Elementor;
namespace Pt_Addons_Elementor\Elements\DualButton;
...
class Dual_Button extends Widget_Base
{
    ...
    {
        return esc_html__('Dual Button', 'pt-addons-elementor');
    }
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'pt_dual_tooltip_color',
			[
				'label' => esc_html__( 'Tooltip Color', 'elementor' ),
				...
				'selectors' => [
					'{{WRAPPER}} .button-tooltip' => 'color: {{VALUE}};',
				],
			]
		);
...
//*** */ testing bg hover color ***/
$this->add_control( /** Add control to set text color of single button when hover on it. */
	'pt_advt_btn1_hover_color',
	[
		'label' => __( 'BG Color 1', 'elementor' ),
		'type' => Controls_Manager::COLOR,
		'selectors' => [
			'{{WRAPPER}} .elementor-button:hover' => 'background-color: {{VALUE}};',
		],
...
//***** */ testing bg hover color ***/
		...
		$this->add_control( /** Add control for background color of dual button hover. */
			...
			[
				'label' => __( 'Background Color btn1', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dbwt-button-left .btn-hover' => 'background-color: {{VALUE}};',
		...
		$this->add_control( /** Add control for background color of dbwt button hover. */
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .dbwt-button-left.style1 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-left.style3 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-left.style2 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-left.style4 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-left.style5 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-left.style6 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-left.style7 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-left.style8 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-left.style1 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-left.style2 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-left.style3 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-left.style4 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-left.style5 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-left.style6 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-left.style7 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-left.style8 .btn-hover' => 'background-color: {{VALUE}};',
		...
		$this->add_control( /** Add style control to select background color for dual button with text for Text Background. */
		...
		$this->add_control( /** Add style control to select Normal background-color for button2. */
		...
		$this->add_control( /** Add control for background color of button2 hover. */
			...
			[
				'label' => __( 'Background Color btn2', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control( /** Add control for background color of dbwt button hover. */
			'pt_dual_btn2_background_hover_color',
			[
				'label' => __( 'Background Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .dbwt-button-right.style1 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-right.style3 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-right.style2 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-right.style4 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-right.style5 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-right.style6 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-right.style7 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dbwt-button-right.style8 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-right.style1 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-right.style2 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-right.style3 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-right.style4 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-right.style5 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-right.style6 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-right.style7 .btn-hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .dual-button-right.style8 .btn-hover' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'pt_adv_btn_option!' => 'adv_btn',
					'pt_dual_btn1_layout' => 'normal',
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'single-wrapper' ); ?>>
			...
			<span class="single-button-text " data-elementor-setting-key="pt_adv_btn1_text" ><?php echo $settings['pt_adv_btn1_text']; ?></span>
			</a>
			<?php
		...
		<div <?php echo $this->get_render_attribute_string( 'adv-dual-wrapper' ); ?>>
			<div class="btn-left" style="float: left">
				<a <?php echo $this->get_render_attribute_string( 'single-button' ); ?>>
					...
					<?php endif; ?>
				<span <?php echo $this->get_render_attribute_string( 'pt-hover' ); ?>></span>
				<span class="dual-button-text " data-elementor-setting-key="pt_adv_btn1_text" ><?php echo $settings['pt_adv_btn1_text']; ?></span>
				</a>
				<?php
				if ( 'yes' === $settings['pt_adv_btn1_tooltip'] ) :
				?>
			...
			<div class="btn-right" style="float: right">
				<a <?php echo $this->get_render_attribute_string( 'dual-button' ); ?>>
					...
					<?php endif; ?>
				<span <?php echo $this->get_render_attribute_string( 'pt-hover' ); ?>></span>
				<span class="dual-button-text " data-elementor-setting-key="pt_adv_btn2_text" ><?php echo $settings['pt_adv_btn2_text']; ?></span>
				</a>
				<?php
	...
	protected function _content_template() {
		...
		<# } #>
				...
				<span class="btn-hover"></span>
					<span class="single-button-text " data-elementor-setting-key="content_description" 
>{{{ settings.pt_adv_btn1_text }}}</span>
		...
		<# } #>
					...
					<# } #>
				<span class="btn-hover"></span>
			<span class="dual-button-text " data-elementor-setting-key="content_description" 
>{{{ settings.pt_adv_btn1_text }}}</span>
			</a>
			<# if ( settings.pt_adv_btn1_tooltip == 'yes') { #>
				<span class="button-tooltip tooltip-position-{{ settings.pt_btn1_tooltip_position }} ">
...
>{{{ settings.pt_adv_btn2_text }}}</span>
		...
		<# } #>
					...
					<# } #>
				<span class="btn-hover"></span>
					<span class="dual-button-text " data-elementor-setting-key="content_description" >{{{ settings.pt_adv_btn1_text }}}</span>
			</a>
			<# if ( settings.pt_adv_btn1_tooltip == 'yes') { #>
				<span class="button-tooltip tooltip-position-{{ settings.pt_btn1_tooltip_position }} ">
				{{{ settings.pt_btn1_tooltip_text }}}
		...
		<# } #>
					...
					<# } #>
				<span class="btn-hover"></span>
					<span class="dual-button-text " data-elementor-setting-key="content_description" >{{{ settings.pt_adv_btn2_text }}}</span>
			</a>
			<# if ( settings.pt_adv_btn2_tooltip == 'yes') { #>
				<span class="button-tooltip tooltip-position-{{ settings.pt_btn2_tooltip_position }} ">
				{{{ settings.pt_btn2_tooltip_text }}}
