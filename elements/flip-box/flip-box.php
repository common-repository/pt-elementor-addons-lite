...
namespace Pt_Addons_Elementor\Elements\FlipBox;
...

{
...

    {
        ...
        return esc_html__('Flip Box', 'pt-addons-elementor');
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .pt-flip-box-front .desc' => 'color: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pt-flip-box-front .desc',
		...
		*/
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .pt-flip-box-back .desc ' => 'color: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pt-flip-box-back .desc',
				...
				<div class="pt-flip-box-back">
					...
					<div class="flipbox-content">
						...
						<?php if ( ! empty( $settings['back_text'] ) ) { ?>
							...
							<div class="elementor-inline-editing desc">
