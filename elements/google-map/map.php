<?php
namespace Elementor;
namespace Pt_Addons_Elementor\Elements\GoogleMap;
...
class Map extends Widget_Base
{
    ...
    {
        return esc_html__('Map', 'pt-addons-elementor');
    }
...
/** repeater control replaced with code new code */
...
$repeater->add_control(
    'map_latitude', [
        ...
        'default' => esc_html__( '18.591212' , 'elementor' ),
...
$repeater->add_control(
    'map_longitude', [
        ...
        'type' => \Elementor\Controls_Manager::TEXT,
        'default' => esc_html__( '73.741261' , 'elementor' ),
        'description'   => 'Click <a href="https://www.latlong.net/" target="_blank">here</a> to get your location coordinates',
        'label_block' => true,
    ]
);
...
$repeater->add_control(
    'pin_title', [
        ...
        'type' => \Elementor\Controls_Manager::TEXT,
        'default' => esc_html__( 'Premium Google Maps' , 'elementor' ),
         'label_block' => true,
    ]
);
$repeater->add_control(
    'pin_desc', [
        ...
        'default' => esc_html__( 'Add something description' , 'elementor' ),
        'show_label' => false,
    ]
);
$this->add_control(
