<?php
namespace Elementor;
namespace Pt_Addons_Elementor\Elements\InfoBox;
...
class Info_Box extends Widget_Base
{
    ...
    {
        return esc_html__('Info Box', 'pt-addons-elementor');
    }
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'layout1' => __( 'Layout1', 'elementor' ),
					'layout2' => __( 'Layout2', 'elementor' ),
				],
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		?>
			<div class="pt-info-box-section pt-info-box-<?php echo $pt_layout_type; ?> to-center">
			  <?php if ( 'layout2' != $pt_layout_type ) { ?>
					<?php if ( 'layout1' === $pt_layout_type ) { ?>
				...
				<?php if ( 'layout2' === $pt_layout_type ) { ?>
					<div class="pt-title elementor-inline-editing"<?php echo $this->get_render_attribute_string( 'pt_title' ); ?>  data-elementor-setting-key="pt_title" data-elementor-inline-editing-toolbar="advanced"><?php echo $title_html; ?></div>
					<div class="pt-description elementor-inline-editing"<?php echo $this->get_render_attribute_string( 'pt_description' ); ?>  data-elementor-setting-key="pt_description" data-elementor-inline-editing-toolbar="advanced"><?php echo $settings['pt_description']; ?>
					<div class="pt-info-box pt-info-box-image-icon-align">
						<?php
						if ( 'image' === $pt_upload_type ) {
							if ( empty( $settings['image']['url'] ) ) {
