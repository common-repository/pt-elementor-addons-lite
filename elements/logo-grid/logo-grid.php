...
$repeater->add_control(
	...
	//*******************Repeater control updated here */	
		...
		$this->add_control(
			'img_width',
			[
				'label' => esc_html__( 'Images Size', 'elementor' ),
				...
				'selectors' => [
					'{{WRAPPER}} .pt-logo-grid-item img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .pt-logo_grid' => 'text-align: {{VALUE}};',
                   ],
            ]
        );
 ...
 $settings = $this->get_settings_for_display();
        ...
        <div class="pt-logo_grid  pt-logo-grid grid-desktop-<?php echo $pt_logo_column_count_desktop.' grid-tablet-'.$pt_logo_column_count_tablet.' grid-mobile-'.$pt_logo_column_count_mobile; ?>">
