      ...
      <div class="pt-modal-box-modal-content">
        ...
        <div class="pt-modal-box-modal-header">
          ...
          <div class="pt-modal-box-modal-body">
			  ...
			  if($settings['pt_modal_box_display_on']=='pageload')
			  {
				?>
			  
			  <script>
			  var delay_time =<?php echo $settings['pt_modal_box_popup_delay']; ?>;
				  
			 setTimeout(function() {
               jQuery(".pt-modal-box-modal").addClass("pt-in");
			  jQuery(".pt-modal-box-modal").css("display","block");
				   
            }, delay_time*1000);
			  
			 
			  
			  jQuery('.pt-modal-box-modal-close').click(function($){
				  jQuery(".pt-modal-box-modal").css("display","none");
				   jQuery(".pt-modal-box-modal").removeClass("pt-in");
			  });
