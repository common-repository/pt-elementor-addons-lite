			...
			'pt_show_excerpt1',
				...
				[
					...
					'options' => [
						...
						'title_excerpt' => __( 'Title & Excerpt','elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					...
					'pt_show_excerpt1'  =>'title_excerpt',
	...
	protected function render() {
		...
		<div class="wptu-ticker-block">
			...
			<?php } ?>
				...
				<p><?php echo wp_trim_words(get_the_excerpt(get_the_ID()), $settings['pt_excerpt_length']); //echo esc_html( $this->pt_get_excerpt_by_id_pro( get_the_ID(), $settings['pt_excerpt_length'] ) ); ?></p>

				

				<?php }
				elseif ($settings['pt_show_excerpt1'] == 'title_excerpt') {

?>
				<span  class="pt_ntTitle">	<?php the_title(); ?> </span>
				<p class="pt_ntcontent"><?php echo wp_trim_words(get_the_excerpt(get_the_ID()), $settings['pt_excerpt_length']); //echo esc_html( $this->pt_get_excerpt_by_id_pro( get_the_ID(), $settings['pt_excerpt_length'] ) ); ?></p>
