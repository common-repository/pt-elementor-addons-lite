<?php
namespace Elementor;
namespace Pt_Addons_Elementor\Elements\PostCarousel;
...
class Post_Carousel extends Widget_Base
{
    ...
    {
        return esc_html__('Post Carousel', 'pt-addons-elementor');
    }
    ...
    protected function render() {
        ...
        if ($loop->have_posts()) : ?>
            ...
            <style>
                ...
                button.slick-next.slick-arrow , .pt-container button.slick-prev{
