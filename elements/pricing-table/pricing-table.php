...
namespace Pt_Addons_Elementor\Elements\PricingTable;
...

{
...

	{
		...
		return esc_html__('Pricing Tables', 'pt-addons-elementor');
	}
	...
	protected function _register_controls()
	{
		...
		$repeater->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::ICON,
				'include' => [
					'fa fa-bitcoin', 'fa fa-btc', 'fa fa-cny', 'fa fa-dollar', 'fa fa-eur', 'fa fa-euro', 'fa fa-gbp',
					'fa fa-ils', 'fa fa-inr', 'fa fa-jpy', 'fa fa-krw', 'fa fa-money', 'fa fa-rmb', 'fa fa-rouble',
					'fa fa-rub', 'fa fa-ruble', 'fa fa-rupee', 'fa fa-shekel', 'fa fa-sheqel', 'fa fa-try',
					'fa fa-turkish-lira', 'fa fa-usd', 'fa fa-won', 'fa fa-yen',
				],
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry s standard dummy text ever since the 1500s', 'elementor'),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .pt-pricing.style-2 .pt-pricing-item.header:after' => 'background-color: {{VALUE}};',
...
// 		Added code by shyam here 
// 		
			
		$this->add_control(

			'pt_pricing_table_BODY_heading',

			[

				'label' => esc_html__('Features Control', 'elementor'),
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							...
							'{{WRAPPER}} .pt-pricing-item .body dd' => 'color: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'name' => 'pt_pricing_table_item_typography',

				'selector' => '{{WRAPPER}} .pt-pricing-item .body dd',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .pt-pricing.style-1 .pt-pricing-item.ribbon-1:before' => 'background-color: {{VALUE}};',

					'{{WRAPPER}} .pt-pricing.style-2 .pt-pricing-item.ribbon-1:before' => 'background-color: {{VALUE}};',

					'{{WRAPPER}} .pt-pricing.style-3 .pt-pricing-item.ribbon-1:before' => 'background-color: {{VALUE}};',

					'{{WRAPPER}} .pt-pricing.style-4 .pt-pricing-item.ribbon-1:before' => 'background-color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Ribbon Height', 'elementor'),
		...
		$this->add_control(
			'more_options',
			[
				'label' => esc_html__( 'Ribbon Style 2 and 3', 'plugin-name' ),
				...
				?>
						...
						<div class="pt-pricing style-1">
							...
							<div class="pt-pricing-item <?php echo esc_attr($featured_class); ?>">
								...
								<div class="pt-pricing-tag">
									...
									<span class="price-tag">
										...
										<?php if ($data['pt_pricing_table_price_cur_placement'] == 'left') : ?>
											...
											<i class="<?php echo esc_attr($data['pt_pricing_table_price_cur']); ?>"></i>
								...
								<?php echo esc_attr($data['pt_pricing_table_price']); ?>
						...
						<div class="pt-pricing style-2">
							...
							<div class="pt-pricing-item <?php echo esc_attr($featured_class); ?>">
								...
								<div class="pt-pricing-icon">
									...
									<span class="icon" style="background:<?php if ('yes' != $settings['pt_pricing_table_icon_bg_show']) : echo 'none';
																			endif;  ?>;">
