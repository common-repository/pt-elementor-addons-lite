...
namespace Pt_Addons_Elementor\Elements\Team;
...

{
...

    {
        ...
        return esc_html__('Team', 'pt-addons-elementor');
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			'section_team_member_social_icons',
...
/****************************  repeater control  *******************************************/
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pt-title .team-title-color',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .designation .designation_title_color',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .pt-team-member-photo-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .pt-team-member-photo-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
...
/**
	...
	protected function render() {
		...
		$this->add_inline_editing_attributes( 'pt_description', 'basic' );

		$this->add_inline_editing_attributes( 'pt_team_title', 'basic' );

		$this->add_inline_editing_attributes( 'team_designation_title', 'basic' );
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css" integrity="sha512-KfkfwYDsLkIlwQp6LFnl8zNdLGxu9YAA1QvwINks4PhcElQSvqcyVLLD9aMhXd13uQjoXtEKNosOWaZqXgel0g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
		...
		<div class="pt-team-section pt-team-<?php echo esc_html( $pt_team_layout_type ); ?> to-center">
			...
			?>
				...
				<div class="pt-title pt-title-text-align "<?php echo $this->get_render_attribute_string( 'pt_team_title' ); ?>  data-elementor-setting-key="pt_team_title" data-elementor-inline-editing-toolbar="advanced"><?php echo $title_html; ?></div>

				<div class="designation designation-text-align info "<?php echo $this->get_render_attribute_string( 'team_designation_title' ); ?>  data-elementor-setting-key="team_designation_title" data-elementor-inline-editing-toolbar="advanced"><h5 class="designation_title_color"><?php echo $settings['team_designation_title']; ?></h5></div>
			...
			if ( 'layout1' === $pt_team_layout_type ) {
				...
				<div class="pt-title pt-title-text-align "<?php echo $this->get_render_attribute_string( 'pt_team_title' ); ?> ><?php echo $title_html; ?></div>

				<div class="designation designation-text-align info "<?php echo $this->get_render_attribute_string( 'team_designation_title' ); ?>><h5 class="designation_title_color"><?php echo $settings['team_designation_title']; ?></h5></div>
			...
			<div class="pt-description elementor-inline-editing"<?php echo $this->get_render_attribute_string( 'pt_description' ); ?>  data-elementor-setting-key="pt_description" data-elementor-inline-editing-toolbar="basic"><?php echo $settings['pt_description']; ?></div>
		...
		<a  href="<?php echo  $item['link']['url']; ?>" <?php if($item['link']['is_external'] == true)echo "target='_blank'"; if( $item['link']['nofollow']==true)echo 'rel="nofollow"'; ?> class="elementor-icon elementor-social-icon elementor-social-icon-<?php echo esc_html( $social . $class_animation ); ?>" >
