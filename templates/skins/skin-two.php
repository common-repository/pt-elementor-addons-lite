...
class Skin_Two extends Skin_Base
{
    ...
    {
        return __('Skin Two', 'pt-addons-elementor');
    }
    ...
    public function section_style_dropdown(Widget_Base $widget)
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'pt-advanced-menu-dropdown-animate-zoom-in',
                'condition' => [
                    'skin_two_pt_advanced_menu_layout' => ['horizontal'],
                ],
                'separator' => 'after',
            ]
        );
    ...
    public function render()
    {
        ...
        $menu_classes = ['pt-advanced-menu', $settings['skin_two_pt_advanced_menu_dropdown_animation'], 'pt-advanced-menu-indicator'];
        $container_classes = ['pt-advanced-menu-container', $settings['skin_two_pt_advanced_menu_item_alignment'], $settings['skin_two_pt_advanced_menu_dropdown_item_alignment']];

        if ($settings['skin_two_pt_advanced_menu_layout'] == 'horizontal') {
            $menu_classes[] = 'pt-advanced-menu-horizontal';
        } else {
            $menu_classes[] = 'pt-advanced-menu-vertical';
        }

        if (isset($settings['skin_two_pt_advanced_menu_item_dropdown_indicator']) && $settings['skin_two_pt_advanced_menu_item_dropdown_indicator'] == 'yes') {
        ...
        $this->parent->add_render_attribute('pt-advanced-menu', [
            ...
            'data-indicator-class' => $settings['skin_two_pt_advanced_menu_item_indicator'],
            'data-dropdown-indicator-class' => $settings['skin_two_pt_advanced_menu_dropdown_item_indicator'],
        ]);
